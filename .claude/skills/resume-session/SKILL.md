...
share one contract: the `▶ Session handoff` block at the top of `PLAN_SHORT.md`,
...
Read `PLAN_SHORT.md`, focusing on the **▶ Session handoff** block. Extract:
...
If a spec change is implied by the planned work, confirm `PLAN_SHORT.md`, `PLAN_LONG.md`,
...
- **This session's goal + tasks:** the unchecked tasks for this session from `PLAN_SHORT.md`.
